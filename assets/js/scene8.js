class Scene8 extends Phaser.Scene {
  ...
  create() {
    ...
    const aContainer = this.add.container(200, 480);
    const aImage = this.add
      .image(0, 0, "aImg")
      .setScale(0.2)
      .setInteractive({ useHandCursor: true });
    const aText = this.add.text(-23, -23, aAnswer, {
      fontSize: "50px",
      color: "#00BBFF",
    });
    ...
    const bImage = this.add
      ...
      .setScale(0.2)
      .setInteractive({ useHandCursor: true });
    const bText = this.add.text(-23, -23, bAnswer, {
      fontSize: "50px",
      color: "#00BBFF",
    });
    ...
    const cImage = this.add
      ...
      .setScale(0.2)
      .setInteractive({ useHandCursor: true });
    const cText = this.add.text(-23, -23, cAnswer, {
      fontSize: "50px",
      color: "#00BBFF",
    });
    ...
    const dImage = this.add
      ...
      .setScale(0.2)
      .setInteractive({ useHandCursor: true });
    const dText = this.add.text(-23, -23, dAnswer, {
      fontSize: "50px",
      color: "#00BBFF",
    });
